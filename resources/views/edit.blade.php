    ...
    <body>
        <div class="container">
            ...
            <form action="{{url('cliente/'.$cliente->id)}}" method="post">
                ...
                <input name = "clave"               class="form-control"    type="text" placeholder="Contraseña del cliente"   
                value="{{old('clave' , $cliente->clave)}}">
                @error('clave')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <br>
                ...
                value="{{old('sueldo_anual' , $cliente->sueldo_anual)}}">
                @error('sueldo_anual')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <br>
                
                <input type="submit" class="btn btn-warning col-md-12" value="Modificar Cliente"></input>
